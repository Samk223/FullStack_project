        ...
        <div class="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
            ...
            <form action="login.php" method="POST">
                <div class="mb-4">
                    ...
                    <input type="email" id="email" name="email" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-600"  autocomplete="off" required>
                </div>
                <div class="mb-4">
